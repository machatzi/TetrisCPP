...
Game::Game(MainWindow& wnd)
    ...
    gfx(wnd)
{
    boardController = new BoardController(board_offset_location, board_width_in_rectangles, board_height_in_rectangles, board_square_length_in_pixels, bord_boarder_widths);
