...
{
    borders_width.left = top_left_out_boarder_width_offset.x;
    borders_width.top = top_left_out_boarder_width_offset.y;

    borders_width.right = bottom_right_in_boarder_width_offset.x;
    borders_width.bottom = bottom_right_in_boarder_width_offset.y;
}
